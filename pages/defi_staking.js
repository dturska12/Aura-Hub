...
import styles from "../styles/Zoe.module.css";

const stakingContractAddress = "0x2257cA8A07fF5f29A0cF88a47AA4d703F4d95c4E";
  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        <h1 className={styles.title}>Earn $ZOE</h1>

        <p className={styles.description}>
          By staking KatNip tokens!
        </p>
